...
def get_confident_answer_string(incoming_msg: str, original_query: str) -> str:
    ...
    Ensures final output is under 1000 characters.
    """
    ...
    **EXAMPLE:**
    ...
    - AI Answer: "I cannot advise you on when to irrigate. I only have price data."
    - Your Direct Output: Based on general agricultural practices, you should check the soil moisture about 4-6 inches deep. The critical stages for wheat irrigation are typically at the Crown Root Initiation (CRI), tillering, flowering, and grain-filling stages. It's always best to consult local agricultural extension services for advice specific to your region's climate and soil.
    """
    ...
    try:
        ...
        return incoming_msg[:997] + "..." if len(incoming_msg) > 1000 else incoming_msg
